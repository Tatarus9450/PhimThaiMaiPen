...
3. กด **เริ่มพูด** หรือ `Meta+H` พูด แล้วกดอีกครั้งเพื่อหยุด Popup เล็กด้านซ้ายแสดง Listening → Thinking → Typing โดยไม่แย่งโฟกัส
4. แก้ข้อความ กด **คัดลอก** แล้ววางเอง หรือกด **อนุญาตวางข้อความ** ในหน้าตั้งค่า แล้วตอบหน้าขอสิทธิ์ของเดสก์ท็อป
5. หากต้องการพิมพ์ลงช่องที่ใช้อยู่ทันที ให้เลือก **ตั้งค่า → เมื่อพูดจบ → วางทันทีเมื่อถอดเสียงเสร็จ** และอนุญาตวางข้อความก่อน เมื่อแอปอยู่เบื้องหลังจะส่งวางหลังถอดเสียงโดยหน่วง 250 มิลลิวินาที หากกด **วางในแอป** จากหน้าตรวจแก้ จะให้เวลา 3 วินาทีเพื่อสลับช่องปลายทาง
