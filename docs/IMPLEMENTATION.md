...
## 2026-09-12 — คืนเสียง Popup (2.0.0.dev4)

ผู้ใช้ยืนยันว่าพูดแล้ววางข้อความได้แล้ว แต่ไม่ได้ยินเสียง Popup ตรวจพบว่า WirePlumber เก็บค่า mute ของกลุ่ม Notification ไว้ แม้ QSoundEffect รายงานว่ากำลังเล่นและไม่ได้ mute ใน Qt

เปลี่ยนเสียงทั้งสี่เป็น QMediaPlayer + QAudioOutput เพื่อใช้ช่องเล่นเสียงปกติ โดยไม่เปลี่ยนค่า mute ของระบบ คืนระดับเสียงวางให้เท่าต้นฉบับ และเพิ่มระดับเสียงเริ่ม/หยุด/สลับโหมดเป็น 65% ข้อความร่างยังอยู่ครบหลังอัปเดต ผู้ใช้ยืนยันว่าได้ยินเสียงจากตัวเล่นใหม่ในการทดสอบ

[หลักฐานเสียง](evidence/popup-sound.json): ตัวเล่นจากแพ็กเกจที่ติดตั้งเล่นไฟล์เดิมซ้ำได้สองครั้ง ตรวจ PipeWire พบ stream กำลังเล่นและไม่ mute การปิดเสียงในแอปหยุดการเล่นครั้งถัดไป ไม่มีการบันทึกไมค์หรือเสียงของแอปอื่น
