...
กำลังเตรียม **2.0.0 beta 2 — รอ CI ตรวจผ่านก่อนเผยแพร่** การติดตั้งใหม่ใช้ **Qwen3-ASR 0.6B + Smart Mix + Auto → CPU + วางทันที** ทดสอบหลักบน **Fedora 44 KDE / Wayland / x86_64** การเร่งด้วย GPU/NPU ยังเป็น Beta และรองรับเป็นรายโมเดลกับอุปกรณ์ ไม่รับรอง Linux ทุกเครื่อง
...
เมื่อ CI ตรวจผ่านและเผยแพร่แล้ว ดาวน์โหลด `PhimThaiMaiPen-2.0.0-beta.2-x86_64.flatpak` และ `SHA256SUMS` จาก [GitHub Releases](https://github.com/Tatarus9450/PhimThaiMaiPen/releases/tag/v2.0.0-beta.2) แล้วเปิดไฟล์ด้วย **Discover** เพื่อติดตั้ง หรือใช้คำสั่ง:
...
**Auto ใช้ CPU ใน beta 2** แอปแสดงคำเตือน **GPU / NPU · Beta** สีแดง เพราะยังอยู่ระหว่างพัฒนาและผลอาจไม่แน่นอน แนะนำ CPU สำหรับใช้งานทั่วไป การตรวจพบ `/dev/accel` อย่างเดียวไม่ทำให้ขึ้นสถานะพร้อมถอดเสียง
